    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='kecheng' ">
                    <el-form-item class="input" v-if="type!='info'"  label="学分" prop="xuenfenNumber">
                        <el-input v-model="kechengForm.xuenfenNumber"
                                  placeholder="学分" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="学分" prop="xuenfenNumber">
            ...
            <input id="kechengId" name="kechengId" type="hidden">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="周次" prop="xingqiTypes">
                        <el-select v-model="ruleForm.xingqiTypes" :disabled="ro.xingqiTypes" placeholder="请选择周次">
                            <el-option
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="周次" prop="xingqiValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="上课地点" prop="paikeAddress">
                       <el-input v-model="ruleForm.paikeAddress"
                                 placeholder="上课地点" clearable  :readonly="ro.paikeAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="上课地点" prop="paikeAddress">
                           <el-input v-model="ruleForm.paikeAddress"
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`paike/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.paikeCrossAddOrUpdateFlag = false;
                                        this.parent.search();
